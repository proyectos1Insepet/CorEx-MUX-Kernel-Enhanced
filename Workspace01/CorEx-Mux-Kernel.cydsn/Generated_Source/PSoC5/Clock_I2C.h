...
#define Clock_I2C_SetDivider(clkDivider)         Clock_I2C_SetDividerRegister(clkDivider, 1u)
#define Clock_I2C_SetDividerValue(clkDivider)    Clock_I2C_SetDividerRegister((clkDivider) - 1u, 1u)
...
#define Clock_I2C_SetPhaseValue(clkPhase)        Clock_I2C_SetPhaseRegister((clkPhase) + 1u)
#endif /* defined(Clock_I2C__CFG3) */
