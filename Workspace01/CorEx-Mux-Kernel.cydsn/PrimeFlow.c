...
PumpTransaction _g_standardtransactions[] = 
{
    ...
    { _PUMP_EOT_, 
        {
            /////////////////////////////////////////////////////////////////////////
            //RETRIEVE TRANSACTION DATA (REALTIME HOSE & VOLUME)
            /////////////////////////////////////////////////////////////////////////
            {
                PumpRTMoneyRequest, //Request Pointer
                ProcessPumpRTMoneyRequest, 
                PumpJobTimeout,
                PNEAR_NULLPTR,
                _EXT_RESPONSE_TIMEOUT_,//Timeout Limit (msecs)
                _NO_TIMEOUT_, //Max repush timeout since this is a LRJ
                PUMP_REALTIME_MONEY_REQUEST_RESPONSE_SIZE,
                //If this flag is set, the "_repushtimeoutlimit" field will be interpreted as retries instead of a "Repush TImeout"
                _REPUSH_ACTIVATED_,
                //Precondition Codes: Validated before executing the main Request.
                //If there are codes within the array and none of them is matched, then "RE-PUSH"
                { true, true, false, false },
                { PUMP_FEOT, PUMP_BUSY, 0xFF, 0xFF },
                //Poscondition Codes:  Validated before executing the Callback.
                //If there are codes within the array and none of them is matched, then "RE-PUSH"
                { false, false, false, false },
                { 0xFF, 0xFF, 0xFF, 0xFF },
            ...
            /////////////////////////////////////////////////////////////////////////
            {
                PumpRTHoseVolumeRequest, //Request Pointer
                ProcessPumpRTHoseVolumeRequest, 
                PumpJobTimeout,
                PNEAR_NULLPTR,
                _EXT_RESPONSE_TIMEOUT_,//Timeout Limit (msecs)
                _NO_TIMEOUT_, //Max repush timeout since this is a LRJ
                PUMP_REALTIME_HOSE_VOLUME_REQUEST_RESPONSE_SIZE,
                //If this flag is set, the "_repushtimeoutlimit" field will be interpreted as retries instead of a "Repush TImeout"
                _REPUSH_ACTIVATED_,
                //Precondition Codes: Validated before executing the main Request.
                //If there are codes within the array and none of them is matched, then "RE-PUSH"
